...
- [adr/0004-cloud-authentication.md](adr/0004-cloud-authentication.md) — accounts (users table, JWT, bcrypt) for cloud sync ✅ (#54–#62)
...
- [specs/…/cloud-authentication-design.md](superpowers/specs/2026-06-06-cloud-authentication-design.md) + [plan](superpowers/plans/2026-06-06-cloud-authentication.md) — register/login, JWT, save-to-cloud, backoffice user mgmt ✅ (#54–#62; Phase 8 mockup refresh pending)
